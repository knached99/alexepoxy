...
export default function Home({auth}){
    ...
    return (
        ...
        <section className="relative bg-cover bg-center h-screen opacity-90" style={{ backgroundImage: "url('https://imgs.search.brave.com/Eo5gVLmOZaL2U4x_wULtXiMaZO0mcrhsnK2I59LC5WE/rs:fit:860:0:0/g:ce/aHR0cHM6Ly93d3cu/ZXBvZGV4LnVzL3dw/LWNvbnRlbnQvdXBs/b2Fkcy8yMDIyLzAy/L2Vwb3h5LWZsb29y/aW5nLmpwZw')"}}>
            <div className="absolute inset-0 flex items-center justify-center text-white text-center">
                <div className="max-w-2xl p-8 bg-opacity-80 backdrop-blur-md shadow-lg">
                    <h1 className="text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl ">Fairfield County Epoxy</h1>
        ...
        <section id="about-us" className="bg-gray-50">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="max-w-screen-md mb-8 lg:mb-16">
                    <h2 className="mb-4 text-4xl font-extrabold text-slate-700 ">About Our Company</h2>
                    <p className="text-gray-500 sm:text-xl ">Welcome to Fairfield County Epoxy, where creativity meets craftsmanship! At Fairfield County Epoxy, we are passionate about transforming ordinary spaces into extraordinary works of art. With a blend of artistic flair and technical expertise, we specialize in crafting stunning epoxy resin creations that elevate the aesthetics of your home or business..</p>
                </div>

                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-slate-700 lg:h-12 lg:w-12 ">
            ...
            <div>
                ...
                <p className="text-gray-500 ">Fairfield County Epoxy is also dedicated to sustainability. We prioritize eco-friendly practices and materials to minimize our environmental impact. Our commitment to sustainability extends to every aspect of our business, from sourcing materials to waste reduction.</p>
            </div>
            ...
            <div>
                ...
                <p className="text-gray-500 ">At Fairfield County Epoxy, we invite you to immerse yourself in the world of epoxy craftsmanship. Explore the boundless possibilities of resin art and witness the magic unfold in your living spaces. Our team is here to guide you through the artistic process, turning your visions into tangible, awe-inspiring creations.</p>
            </div>
        ...
        <h1 className="text-4xl text-center m-4 font-black text-slate-700">Photo Gallery</h1>
    ...
    <h6 className="text-center text-xl text-slate-700">Nothing in the photo gallery</h6>
    )}
    ...
    <div className="lightbox">
        ...
        <section className="bg-white" id="contact-us">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center">
                    <h2 className="mb-4 text-4xl font-extrabold leading-tight text-slate-700">Ready to dive into the world of stunning epoxy creations?</h2>
        ...
        <footer className="p-4 sm:p-6" style={{backgroundColor: '#000000'}}>
            <div className="mx-auto max-w-screen-xl">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="#" className="flex items-center">
                        <span className="self-center text-2xl text-white font-black whitespace-nowrap ">Fairfield County Epoxy</span>
                        </Link>
                    </div>
                </div>
                <Footer/>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-100 sm:text-center ">© {new Date().getFullYear()} <Link to="#" className="hover:underline">Fairfield County Epoxy</Link>. All Rights Reserved.
                        </span>
